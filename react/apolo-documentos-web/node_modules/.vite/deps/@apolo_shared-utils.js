...
// node_modules/@apolo/shared-utils/src/formatting/date.js
var formatoFechaHora = (value) => {
  if (value === null) return "";
  const fecha = new Date(new Date(value).toLocaleString("en-US", { timeZone: "UTC" }));
  return fecha.getDate().toString().padStart(2, 0) + "/" + (fecha.getMonth() + 1).toString().padStart(2, 0) + "/" + fecha.getFullYear() + " " + fecha.getHours().toString().padStart(2, 0) + ":" + fecha.getMinutes().toString().padStart(2, 0) + ":" + fecha.getSeconds().toString().padStart(2, 0);
};
var formatoFecha = (value = null) => {
  if (value === null) return "";
  const fecha = new Date(new Date(value).toLocaleString("en-US", { timeZone: "UTC" }));
  return fecha.getDate().toString().padStart(2, 0) + "/" + (fecha.getMonth() + 1).toString().padStart(2, 0) + "/" + fecha.getFullYear();
};
var formatoFechaEstadoCuenta = (value) => {
  if (value === null) return "";
  const fecha = new Date(new Date(value).toLocaleString("en-US", { timeZone: "UTC" }));
  const M = fecha.toLocaleString("es-ES", { timeZone: "UTC", month: "long" });
  const Mes = M.charAt(0).toUpperCase() + M.slice(1);
  return fecha.getDate() + " " + Mes + " " + fecha.getFullYear();
};
var fechaInternacional = (fechaStr) => {
  const [dia, mes, year] = fechaStr.split("/");
  return `${year}-${mes}-${dia}`;
};
var fechaExpiracion = (dateStr) => {
  if (dateStr === null) return "";
  const fecha = new Date(new Date(dateStr).toLocaleString("en-US", { timeZone: "UTC" }));
  const month = (fecha.getMonth() + 1).toString().padStart(2, "0");
  const year = fecha.getFullYear() % 100;
  return `${month}/${year}`;
};

// node_modules/@apolo/shared-utils/src/validation/null-checks.js
var isNullOrUndefined = (dato) => {
  return dato === null || dato === void 0;
};
var isNullOrUndefinedOrEmpty = (value) => {
...
var contieneNumeros = (value) => {
  const reg = new RegExp("^[a-zA-Z ]+$");
  return reg.test(value);
};

// node_modules/@apolo/shared-utils/src/formatting/currency.js
var formatoMoneda = (value) => {
  if (isNullOrUndefinedOrEmpty(value)) return "";
  return value.toLocaleString("es-CL", { style: "currency", currency: "CLP" });
};
var formatoInternacional = (value) => {
  if (isNullOrUndefinedOrEmpty(value)) return "";
  return value.toLocaleString("en-EN", { style: "currency", currency: "USD" });
};

// node_modules/@apolo/shared-utils/src/formatting/card-number.js
var formatoNumeroCuentaTarjeta = (numero) => {
  const numeroLimpio = numero.toString().replace(/^0+/, "");
  return agregarCaracter(numeroLimpio, " ", 4);
};
var ofuscarNumero = (str) => {
...
var ofuscarNumeroConAsteriscos = (str, cortado = false) => {
...
// node_modules/@apolo/shared-utils/src/formatting/text.js
var primeraLetraMayusculas = (string) => {
  if (isNullOrUndefinedOrEmpty(string)) return "";
  return string.charAt(0).toUpperCase() + string.slice(1).toLowerCase();
};
var removeTilde = (string) => {
  return string.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
};
var replaceSpecialChar = (value) => {
  return value.replace(/[áäâàã]/gi, "a").replace(/[éëêè]/gi, "e").replace(/[íïîì]/gi, "i").replace(/[óöôòõ]/gi, "o").replace(/[úüûù]/gi, "u").replace(/ñ/gi, "n").replace(/[^a-zA-Z\s]/gi, "");
};

// node_modules/@apolo/shared-utils/src/validation/cache.js
var omitirConsulta = (ultimaConsulta, intervalo) => {
  if (isNullOrUndefinedOrEmpty(ultimaConsulta)) return false;
  const now = /* @__PURE__ */ new Date();
  const prev = new Date(ultimaConsulta);
  return now.getTime() - prev.getTime() < intervalo;
};

// node_modules/@apolo/shared-utils/src/builders/cuenta-builders.js
var estado_pago_null = {
  monto_facturado: null,
  total_abonos: null,
  pago_minimo: null,
  glosa: ""
};
var bloqueos_cuenta_null = {
...
var construirCuentaPrincipal = async (data, idCuenta, visualizarDatosOfuscados, desencriptarFn = null) => {
  var _a;
  if (isNullOrUndefinedOrEmpty(data)) return null;
  const numero_cuenta_tac_desencriptado = visualizarDatosOfuscados && !isNullOrUndefinedOrEmpty(data.numero_cuenta_tac) && desencriptarFn ? formatoNumeroCuentaTarjeta(await desencriptarFn(data.numero_cuenta_tac)) : "";
  return {
    id_cuenta: isNullOrUndefinedOrEmpty(data.id_cuenta) ? idCuenta : data.id_cuenta,
    numero_cuenta: data.numero_cuenta,
    estado: data.estado_autorizador_cuenta.descripcion ? data.estado_autorizador_cuenta.descripcion.toLowerCase() : "",
    ...
    estado_pago: isNullOrUndefinedOrEmpty(data.estado_pago) ? estado_pago_null : {
      ...
      glosa: !isNullOrUndefinedOrEmpty(data.estado_pago.glosa) ? primeraLetraMayusculas(data.estado_pago.glosa) : ""
    },
    ...
    monto_facturado: ((_a = data.estado_pago) == null ? void 0 : _a.monto_facturado) ?? null,
...
var construirCuentaAdicional = (data) => {
  var _a;
  if (isNullOrUndefinedOrEmpty(data)) return null;
  return {
    id_cuenta: data.cuenta.id_cuenta,
    numero_cuenta: data.cuenta.numero_cuenta,
    estado: data.cuenta.estado_autorizador_cuenta.descripcion ? data.cuenta.estado_autorizador_cuenta.descripcion.toLowerCase() : "",
    castigada: data.es_castigada,
    numero_cuenta_tac: data.numero_cuenta_tac,
    numero_cuenta_tac_desencriptado: "",
    bloqueos: {
...
var construirCuentaNoVigente = (data, idCuenta) => {
  var _a;
  if (isNullOrUndefinedOrEmpty(data)) return null;
  return {
    id_cuenta: idCuenta,
    ...
    numero_cuenta_tac: data.numero_cuenta_tac,
    numero_cuenta_tac_desencriptado: "",
    bloqueos: isNullOrUndefinedOrEmpty(data.bloqueo_cuentas) ? bloqueos_cuenta_null : {
...
// node_modules/@apolo/shared-utils/src/builders/tarjeta-builders.js
var bloqueos_tarjeta_null = {
  id: null,
  codigo: null,
  descripcion: null,
  permite_compra: null,
...
var construirTarjetaPrincipal = async (data, visualizarDatosOfuscados, desencriptarFn = null) => {
  var _a, _b, _c, _d, _e, _f;
  if (isNullOrUndefinedOrEmpty(data)) return null;
  const filtrarTarjetaPrincipal = (_a = data.tarjetas) == null ? void 0 : _a.find((t2) => t2.es_principal === true);
  if (isNullOrUndefinedOrEmpty(filtrarTarjetaPrincipal)) return null;
  const t = filtrarTarjetaPrincipal;
  const numero_tarjeta_tac_desencriptado = visualizarDatosOfuscados && !isNullOrUndefinedOrEmpty(t.numero_tarjeta_tac) && desencriptarFn ? formatoNumeroCuentaTarjeta(await desencriptarFn(t.numero_tarjeta_tac)) : "";
  return {
    ...
    firma: !data.firma,
    estado: t.estado_autorizador_tarjeta.descripcion ? t.estado_autorizador_tarjeta.descripcion.toLowerCase() : "",
    expiracion: formatoFecha(t.fecha_vencimiento_tarjeta),
    bloqueo: {
      id: ((_b = t.bloqueo_tarjeta) == null ? void 0 : _b.id) ?? null,
      codigo: ((_c = t.bloqueo_tarjeta) == null ? void 0 : _c.codigo) ?? null,
      descripcion: ((_d = t.bloqueo_tarjeta) == null ? void 0 : _d.descripcion) ?? null,
      permite_compra: ((_e = t.bloqueo_tarjeta) == null ? void 0 : _e.permite_compra) ?? null,
      fecha_hora_bloqueo: ((_f = t.bloqueo_tarjeta) == null ? void 0 : _f.fecha_hora_bloqueo) ?? null
    },
...
var construirTarjetaAdicional = (data) => {
  var _a, _b, _c, _d, _e;
  if (isNullOrUndefinedOrEmpty(data)) return null;
  return {
    ...
    firma: data.firma,
    estado: data.estado_autorizador_tarjeta.descripcion ? data.estado_autorizador_tarjeta.descripcion.toLowerCase() : "",
    expiracion: formatoFecha(data.fecha_vencimiento_tarjeta),
    bloqueo: {
      id: ((_a = data.bloqueos_tarjeta) == null ? void 0 : _a.id) ?? null,
      codigo: ((_b = data.bloqueos_tarjeta) == null ? void 0 : _b.codigo) ?? null,
      descripcion: ((_c = data.bloqueos_tarjeta) == null ? void 0 : _c.descripcion) ?? null,
      permite_compra: ((_d = data.bloqueos_tarjeta) == null ? void 0 : _d.permite_compra) ?? null,
      fecha_hora_bloqueo: ((_e = data.bloqueos_tarjeta) == null ? void 0 : _e.fecha_hora_bloqueo) ?? null
    },
...
var construirTarjetaNoVigente = (data) => {
  ...
  return {
    ...
    numero_tarjeta_tac_desencriptado: "",
    logo: {
      id: ((_a = data.logo) == null ? void 0 : _a.id) ?? null,
      codigo: ((_b = data.logo) == null ? void 0 : _b.codigo) ?? null,
      descripcion: ((_c = data.logo) == null ? void 0 : _c.descripcion) ?? null
    },
    tarjeta_digital: data.es_digital ?? null,
    firma: false,
    estado: "inactiva",
    expiracion: !isNullOrUndefinedOrEmpty(data.fecha_vencimiento_tarjeta) ? formatoFecha(data.fecha_vencimiento_tarjeta) : null,
    bloqueo: isNullOrUndefinedOrEmpty(data.bloqueo_tarjeta) ? bloqueos_tarjeta_null : {
      id: ((_d = data.bloqueo_tarjeta) == null ? void 0 : _d.id) ?? null,
      codigo: ((_e = data.bloqueo_tarjeta) == null ? void 0 : _e.codigo) ?? null,
      descripcion: ((_f = data.bloqueo_tarjeta) == null ? void 0 : _f.descripcion) ?? null,
      permite_compra: ((_g = data.bloqueo_tarjeta) == null ? void 0 : _g.permite_compra) ?? null,
      fecha_hora_bloqueo: ((_h = data.bloqueo_tarjeta) == null ? void 0 : _h.fecha_hora_bloqueo) ?? null
    },
...
// node_modules/@apolo/shared-utils/src/builders/selector-tarjetas.js
var new_selector_tarjetas_embozados = (embozado) => {
  return {
    codigo_logo: embozado.logo.codigo,
    numero_tarjeta: ofuscarNumeroConAsteriscos(embozado.numero_tarjeta),
    nombre_cliente: embozado.nombre_cliente,
    id_tarjeta: embozado.id_tarjeta,
    boton: {
      label: "Embozar",
      icono: null,
      isNavigate: true,
      ruta: `/embozado/${embozado.id_tarjeta}`,
      metodo: null,
      disabled: false
    },
    en_curso: false,
...
var new_selector_tarjetas_embozados_en_curso = (embozado) => {
  return {
    codigo_logo: embozado.CodigoLogo,
    numero_tarjeta: ofuscarNumeroConAsteriscos(embozado.NroTarjeta),
    nombre_cliente: embozado.NombrePersona,
    id_tarjeta: embozado.IdTarjeta,
    boton: {
      label: "Embozado en curso",
      icono: null,
      isNavigate: true,
      ruta: `/embozado/${embozado.IdTarjeta}`,
      metodo: null,
      disabled: false
    },
    en_curso: true,
    background_color: "en-curso"
  };
};

// node_modules/@apolo/shared-utils/src/file/download.js
var base64ToBlob = (base64Data, contentType) => {
...
var descargarArchivo = (base64Data, fileName, contentType) => {
  try {
...
var descargarPdfBase64 = (data, nombre_archivo) => {
  const pdfLink = `data:application/pdf;base64,${data}`;
...
// node_modules/@apolo/shared-utils/src/file/export.js
var exportTrxToExcel = (table) => {
  const currentRows = table.getRowModel().rows.map((row) => row.original);
  const worksheet = utils.json_to_sheet(currentRows);
  const workbook = utils.book_new();
  utils.book_append_sheet(workbook, worksheet, "Transacciones");
  writeFileSync(workbook, "transacciones_RDR.xlsx");
};
var exportTableCurrentState = (table, fileName) => {
...
export {
  base64ToBlob,
  construirCuentaAdicional,
  construirCuentaNoVigente,
  construirCuentaPrincipal,
  construirTarjetaAdicional,
  construirTarjetaNoVigente,
  construirTarjetaPrincipal,
  contieneNumeros,
  descargarArchivo,
  descargarPdfBase64,
  exportTableCurrentState,
  exportTrxToExcel,
  fechaExpiracion,
  fechaInternacional,
  formatoFecha,
  formatoFechaEstadoCuenta,
  formatoFechaHora,
  formatoInternacional,
  formatoMoneda,
  formatoNumeroCuentaTarjeta,
  isNullOrUndefined,
  isNullOrUndefinedOrEmpty,
  new_selector_tarjetas_embozados,
  new_selector_tarjetas_embozados_en_curso,
  ofuscarNumero,
  ofuscarNumeroConAsteriscos,
  omitirConsulta,
...
*/
//# sourceMappingURL=@apolo_shared-utils.js.map
